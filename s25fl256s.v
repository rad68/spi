...
///////////////////////////////////////////////////////////////////////////////
    ...
    parameter mem_file_name     = "s25fl256s.mem";//"none";//
    parameter otp_file_name     = "none";//"s25fl256sOTP.mem";//

    parameter TimingModel       = "s25fl256sagmfi000_f_30pF";//"DefaultTimingModel";
    ...
    integer Mem[OTPLoAddr:OTPHiAddr];
                ...
                begin
                    ...
                    begin
                        ...
                        begin
                            ...
                            //TODO: Commented out because this is bullshit
                            if (Mem[read_addr] !== -1)
                            begin
